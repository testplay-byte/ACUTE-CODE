...
import { bdr, shortUtcDay, utcDateLabel, withAlpha } from "./helpers";

/**
 * Token bar chart ported from the dashboard demo (TokenBarChart.tsx), fed by
 * the LIVE usage summary endpoint instead of the demo's mock week. Bars are
 * total tokens per UTC day (input+output); the hover tooltip breaks a day into
 * input/output/requests/cost since the API has no per-project breakdown yet.
 */
