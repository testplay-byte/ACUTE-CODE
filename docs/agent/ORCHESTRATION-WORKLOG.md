...
- GATES: lint clean, typecheck clean, 750/750 in 62 files (agent-core 470/29 — +10; frontend 280/33 — +1/−13); version 0.49.0 ×4 via version.mjs; docs:check green; CHANGELOG [0.49.0] user-facing.
