...
Generated by `scripts/license-audit.mjs` (`pnpm license:audit`) on 2026-09-18. Do not edit by hand.
...
| @antfu/install-pkg | 2.0.1 | MIT | OK |
| @braintree/sanitize-url | 7.1.2 | MIT | OK |
| @chevrotain/types | 11.1.2 | Apache-2.0 | OK |
...
| @types/d3 | 7.4.3 | MIT | OK |
| @types/d3-array | 3.2.2 | MIT | OK |
| @types/d3-axis | 3.0.6 | MIT | OK |
| @types/d3-brush | 3.0.6 | MIT | OK |
| @types/d3-chord | 3.0.6 | MIT | OK |
| @types/d3-color | 3.1.3 | MIT | OK |
| @types/d3-contour | 3.0.6 | MIT | OK |
| @types/d3-delaunay | 6.0.4 | MIT | OK |
| @types/d3-dispatch | 3.0.7 | MIT | OK |
| @types/d3-drag | 3.0.7 | MIT | OK |
| @types/d3-dsv | 3.0.7 | MIT | OK |
| @types/d3-ease | 3.0.2 | MIT | OK |
| @types/d3-fetch | 3.0.7 | MIT | OK |
| @types/d3-force | 3.0.10 | MIT | OK |
| @types/d3-format | 3.0.4 | MIT | OK |
| @types/d3-geo | 3.1.1 | MIT | OK |
| @types/d3-hierarchy | 3.1.7 | MIT | OK |
| @types/d3-interpolate | 3.0.4 | MIT | OK |
| @types/d3-path | 3.1.1 | MIT | OK |
| @types/d3-polygon | 3.0.2 | MIT | OK |
| @types/d3-quadtree | 3.0.6 | MIT | OK |
| @types/d3-random | 3.0.4 | MIT | OK |
| @types/d3-scale | 4.0.9 | MIT | OK |
| @types/d3-scale-chromatic | 3.1.0 | MIT | OK |
| @types/d3-selection | 3.0.11 | MIT | OK |
| @types/d3-shape | 3.2.0 | MIT | OK |
| @types/d3-time | 3.0.4 | MIT | OK |
| @types/d3-time-format | 4.0.3 | MIT | OK |
| @types/d3-timer | 3.0.2 | MIT | OK |
| @types/d3-transition | 3.0.9 | MIT | OK |
| @types/d3-zoom | 3.0.8 | MIT | OK |
...
| cookie | 1.1.1 | MIT | OK |
| cose-base | 1.0.3 | MIT | OK |
| cose-base | 2.2.0 | MIT | OK |
| csstype | 3.2.3 | MIT | OK |
| cytoscape | 3.34.3 | MIT | OK |
| cytoscape-cose-bilkent | 4.1.0 | MIT | OK |
| cytoscape-fcose | 2.2.0 | MIT | OK |
| d3 | 7.9.0 | ISC | OK |
| d3-array | 2.12.1 | BSD-3-Clause | OK |
| d3-array | 3.2.4 | ISC | OK |
| d3-axis | 3.0.0 | ISC | OK |
| d3-brush | 3.0.0 | ISC | OK |
| d3-chord | 3.0.1 | ISC | OK |
| d3-color | 3.1.0 | ISC | OK |
| d3-contour | 4.0.2 | ISC | OK |
| d3-delaunay | 6.0.4 | ISC | OK |
| d3-dispatch | 3.0.1 | ISC | OK |
| d3-drag | 3.0.0 | ISC | OK |
| d3-dsv | 3.0.1 | ISC | OK |
| d3-ease | 3.0.1 | BSD-3-Clause | OK |
| d3-fetch | 3.0.1 | ISC | OK |
| d3-force | 3.0.0 | ISC | OK |
| d3-format | 3.1.2 | ISC | OK |
| d3-geo | 3.1.1 | ISC | OK |
| d3-hierarchy | 3.1.2 | ISC | OK |
| d3-interpolate | 3.0.1 | ISC | OK |
| d3-path | 1.0.9 | BSD-3-Clause | OK |
| d3-path | 3.1.0 | ISC | OK |
| d3-polygon | 3.0.1 | ISC | OK |
| d3-quadtree | 3.0.1 | ISC | OK |
| d3-random | 3.0.1 | ISC | OK |
| d3-sankey | 0.12.3 | BSD-3-Clause | OK |
| d3-scale | 4.0.2 | ISC | OK |
| d3-scale-chromatic | 3.1.0 | ISC | OK |
| d3-selection | 3.0.0 | ISC | OK |
| d3-shape | 1.3.7 | BSD-3-Clause | OK |
| d3-shape | 3.2.0 | ISC | OK |
| d3-time | 3.1.0 | ISC | OK |
| d3-time-format | 4.1.0 | ISC | OK |
| d3-timer | 3.0.1 | ISC | OK |
| d3-transition | 3.0.1 | ISC | OK |
| d3-zoom | 3.0.0 | ISC | OK |
...
| jwa | 2.0.1 | MIT | OK |
| jws | 4.0.1 | MIT | OK |
| katex | 0.16.47 | MIT | OK |
| khroma | 2.1.0 | MIT (raw: Unknown; ADR-0030) | OK (ADR-0030) |
...
| marked | 16.4.2 | MIT | OK |
| mermaid | 11.17.2 | MIT | OK |
...
| rfdc | 1.4.1 | MIT | OK |
| robust-predicates | 3.0.3 | Unlicense (raw: Unlicense; ADR-0030) | OK (ADR-0030) |
| roughjs | 4.6.6 | MIT | OK |
| rw | 1.3.3 | BSD-3-Clause | OK |
