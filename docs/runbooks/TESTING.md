...
**Current counts (R69, verified 2026-09-05 by re-running the suites):**
the root `pnpm test` = **2082 tests in 123 files** (all workspace suites
from the root vite config; agent-core alone = **1180/1180 in 60 files**,
frontend `src/` alone = **890/890 in 61 files** (unchanged — R69 touched
zero frontend files), root `tests/` e2e = 12, re-run 12/12).
