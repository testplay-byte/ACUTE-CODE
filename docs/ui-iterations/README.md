...
| Project chat (`/project/:id/chat`) | R9 M3 port → R10 demo-parity (full TopBar: agent picker + file search + theme grid + Experimental freeform + To-Do panel; 7 tools) | **IN REVIEW** — R10 delivered, live-verified on P1 |
